...
/*	'DISABLE_EXPORT'=>'Disable export',*/
    ...
    'LIST_VIEW_SELECT_TO_EMAIL' => 'Max number of email recipients built from a List View',
    'LIST_VIEW_SELECT_TO_EMAIL_HELP' => 'When selecting records from a list view and selecting the Email action, too many recipients will slow the system. What is the maximum number of recipients you will allow Users to select? Default is 10.',
