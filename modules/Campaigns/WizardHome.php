...
global $currentModule;
	...
	$WizardHomeHTMLLocation = (file_exists('custom/modules/Campaigns/WizardHome.html')) ? 'custom/modules/Campaigns/WizardHome.html' : 'modules/Campaigns/WizardHome.html';
    $ss->display($WizardHomeHTMLLocation);
...
*/
    ...
    $ss->assign("MOD", $mod_strings);
    $ss->assign("APP", $app_strings);
	$WizardHomeStartTplLocation = (file_exists('custom/modules/Campaigns/tpls/WizardHomeStart.tpl')) ? 'custom/modules/Campaigns/tpls/WizardHomeStart.tpl' : 'modules/Campaigns/tpls/WizardHomeStart.tpl';
    $ss->display($WizardHomeStartTplLocation);
